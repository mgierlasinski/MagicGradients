...
namespace Playground.ViewModels
{
    ...
    {
        public List<ILinearGradientSource> Gradients { get; set; }

        private ILinearGradientSource _selectedItem;
        public ILinearGradientSource SelectedItem
        {
            get => _selectedItem;
        ...
        {
            Gradients = new List<ILinearGradientSource>
            {
