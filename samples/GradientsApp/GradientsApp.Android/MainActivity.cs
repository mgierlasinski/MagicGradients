    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        private void SetGradient()
        {
            ...
            new GradientBuilder()
                ...
                .BuildFor(FindViewById<GradientView>(Resource.Id.magicRainbow));
            ...
            new GradientBuilder()
                ...
                .BuildFor(FindViewById<GradientView>(Resource.Id.magicAngular));

            var maskView = FindViewById<GradientView>(Resource.Id.pathMask);
